...
number1,operator,number2=input("Enter two number separated by an operator").split()
...
# Ask for the age
ageDeterminGrade=eval(input("Enter your age : "))

# Handle if age < 5
if ageDeterminGrade<5 :
    print("too young")


# Special output just for age 5
elif ageDeterminGrade==5 :
...
elif (ageDeterminGrade>5 and ageDeterminGrade<18):
    grade=ageDeterminGrade-5
    print(f"go to {grade} grade")


# Handle everyone else
elif ageDeterminGrade>17:
    print("go to college")
